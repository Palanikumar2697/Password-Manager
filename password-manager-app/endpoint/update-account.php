    ...
    $created_at = date("Y-m-d H:i:s");  
        ...
        try {
            ...
            if (!empty($accountExists)) {
                ...
                $updateStmt = $conn->prepare("UPDATE `tbl_accounts` SET `account_name` = :account_name, `username` = :username, `password` = :password, `link` = :link, `description` = :description,`created_at`= :created_at  WHERE `tbl_account_id` = :accountID AND `tbl_user_id` = :user_id");
